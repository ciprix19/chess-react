...
function generateChessBoard() {
    ...
    boardMatrix[0][0].piece = { type: 'rook', color: 'black', value: 5 };
    boardMatrix[0][7].piece = { type: 'rook', color: 'black', value: 5 };
    boardMatrix[7][0].piece = { type: 'rook', color: 'white', value: 5 };
    boardMatrix[7][7].piece = { type: 'rook', color: 'white', value: 5 };
    ...
    boardMatrix[0][4].piece = { type: 'king', color: 'black', value: 0 };
    boardMatrix[7][4].piece = { type: 'king', color: 'white', value: 0 };
